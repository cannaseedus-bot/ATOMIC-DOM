...
export class FeaturesComponent {
  features = signal<Feature[]>([
    {
      title: 'Blazing Fast',
      description: 'Leverages an immutable, tree-shakable structure for unparalleled rendering performance and minimal overhead.',
    ...
    },
    {
      ...
      description: 'Prevents direct manipulation, eliminating a whole class of bugs and side effects common in web development.',
    ...
    },
    {
      ...
      description: 'A sandboxed environment that mitigates XSS and other injection attacks by enforcing a strict capability-based model.',
    ...
    },
    {
      ...
      description: 'Enjoy full type safety and autocompletion out-of-the-box with a DOM API designed from the ground up for TypeScript.',
